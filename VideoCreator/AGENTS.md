# AGENTS.md instructions for VideoCreator

## Scope

- These instructions apply to all work inside `VideoCreator/`.
...
- remotion-best-practices: Best practices for Remotion - Video creation in React. (file: `.claude/skills/remotion-best-practices/SKILL.md`)
- video-orchestrator: End-to-end orchestration for this workspace. (file: `VideoCreator/skills/video-orchestrator/SKILL.md`)
- video-asset-prep: Input normalization, subtitle text preparation, and required web image sourcing. (file: `VideoCreator/skills/video-asset-prep/SKILL.md`)
- video-remotion-editor: Remotion-based composition editing and rendering using `project.json`. (file: `VideoCreator/skills/video-remotion-editor/SKILL.md`)
...
- Before implementing Remotion-related changes, open `.claude/skills/remotion-best-practices/SKILL.md`.
