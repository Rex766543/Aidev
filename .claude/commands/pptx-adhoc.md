...
特定の課題や検討事項についてのパワポ資料を作成するコマンドです。
...
```
project-alpha/presentations/adhoc/{DATE}/_input.md
```
...
インプット内容と参照資料をもとに、`.claude/skills/pptx-generator/SKILL.md` の「アドホック課題資料 (adhoc)」構成テンプレートに従いスライドを設計し、即座にコンテンツを作成する。
...
- 保存先: `project-alpha/presentations/adhoc/{DATE}/{タイトル}.pptx`
- フォント: Meiryo
...
レビュー対象: project-alpha/presentations/adhoc/{DATE}/{タイトル}.pptx
