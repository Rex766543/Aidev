...
- `mixed-source-issue-outline`: combine transcript and local text files into one issue-oriented outline
...
- Supplemental text files can live anywhere in the workspace as long as you provide their paths in the request.
